Rails.application.routes.draw do
  ...
  namespace :api, defaults: {format: :json} do
    ...
    resources :articles, only: [:show, :index, :create, :update, :destroy, :new]
    resources :tags, only: [:create, :destroy, :new]
    resources :copies, only: [:show, :index, :create, :update, :destroy, :new]
    resources :bookshelves, only: [:show, :index, :create, :update, :destroy, :new]
    resources :descriptions, only: [:show, :index, :create, :update, :destroy, :new]
  end
